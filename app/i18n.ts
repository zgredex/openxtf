...
export const TRANSLATIONS = {
  ko: {
    ...
    diagnosticImageJpegExact: 'JPEG · V6.3.15 디코더 / 새 캐시 위상',
  ...
  en: {
    ...
    diagnosticDecodedSize: 'Decoder output',
    ...
    diagnosticDitherPhase: 'Dither phase',
    ...
    diagnosticImageJpegExact: 'JPEG · V6.3.15 decoder / fresh-cache phase',
