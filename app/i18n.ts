...
export const TRANSLATIONS = {
  ko: {
    ...
    diagnosticAdvanceRulesHint:
      'ASCII U+0020–U+007E는 글자별 표를 사용하고, 일반 한글·CJK는 헤더 전각 너비를 사용합니다. U+0080–024F, U+0370–052F, U+0590–08FF, U+0E00–0E7F, U+1E00–1EFF, U+2000–22FF의 일부 문자는 실제 잉크를 스캔한 글리프 메타데이터 너비를 사용하며, 결합 문자·조이너·변형 선택자는 0폭 규칙을 따릅니다.',
  ...
  en: {
    ...
    diagnosticAdvanceRulesHint:
      'ASCII U+0020–U+007E uses its per-character table; ordinary Hangul/CJK uses the header full width. Selected characters in U+0080–024F, U+0370–052F, U+0590–08FF, U+0E00–0E7F, U+1E00–1EFF and U+2000–22FF use glyph metadata after an ink scan, while combining marks, joiners and variation selectors follow the zero-width rule.',
    diagnosticAdvanceSources: {
    ...
    diagnosticTopBaseline: 'Top / baseline',
