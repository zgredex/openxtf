...
export const TRANSLATIONS = {
  ko: {
    ...
    textSpacingAndRhythm: '글자 간격과 폭',
    strokeAppearance: '획 모양',
    cellWidth: '셀 너비',
    cellHeight: '셀 높이',
    cropLeft: '왼쪽 자르기',
    cropTop: '위쪽 자르기',
    storedAdvanceY: '줄 기준 간격(advanceY)',
    fullWidthAdvance: '한글·CJK 전각 너비',
    asciiMeanWidth: 'ASCII 대체 너비',
    ascender: '어센더',
    descender: '디센더',
    effectiveWordSpace: '단어 간격(U+0020)',
    xtfMetricsHint:
      'V6.3.15의 활성 XTF 경로는 일반 한글의 줄바꿈 너비와 그리기 전진 폭에 모두 전각 너비를 사용합니다. 셀 너비는 저장되는 비트맵 영역이며, 단어 공백은 XTF의 ASCII U+0020 너비 표에서 가져옵니다.',
    ...
    advanceYHelp: 'V6.3.15가 줄 간격 계산의 기준으로 사용하는 XTF 값입니다. 0이면 셀 높이로 대체됩니다.',
    fullWidthAdvanceHelp: '활성 XTF 경로에서 일반 한글 한 음절의 줄바꿈 측정과 그리기 전진에 모두 사용되는 너비입니다.',
    asciiMeanWidthHelp: 'ASCII 글자별 너비가 없거나 0일 때와, EPUB의 줄바꿈 금지 공백이 내부 U+0007로 그려질 때 사용하는 XTF 대체 너비입니다. 일반 공백은 U+0020 글자별 너비를 사용합니다.',
    diagnosticCellHeightFallback: '셀 높이 대체',
    wordSpaceHelp: 'XTF의 ASCII 너비 표에 저장되는 U+0020 공백 너비입니다. 표 값이 0이면 ASCII 기본 너비를 사용합니다.',
  ...
  en: {
    ...
    textSpacingAndRhythm: 'Character spacing and width',
    strokeAppearance: 'Stroke appearance',
    cellWidth: 'Cell width',
    cellHeight: 'Cell height',
    cropLeft: 'Crop left',
    cropTop: 'Crop top',
    storedAdvanceY: 'Line advance (advanceY)',
    fullWidthAdvance: 'Hangul/CJK full width',
    asciiMeanWidth: 'ASCII fallback width',
    ascender: 'Ascender',
    descender: 'Descender',
    effectiveWordSpace: 'Word space (U+0020)',
    xtfMetricsHint:
      'The active V6.3.15 XTF path uses full width for both ordinary Hangul wrapping and painted advance. Cell width is the stored bitmap area; word space comes from the XTF ASCII U+0020 width table.',
    ...
    advanceYHelp: 'The XTF value V6.3.15 uses as the base for line-spacing calculations. A zero value falls back to cell height.',
    fullWidthAdvanceHelp: 'The width used for both line-split measurement and painted advance of each ordinary Hangul syllable in the active XTF path.',
    asciiMeanWidthHelp: 'The XTF fallback used when a per-character ASCII width is absent or zero, and when EPUB non-breaking space is painted as internal U+0007. Ordinary spaces use the per-character U+0020 width.',
    diagnosticCellHeightFallback: 'cell-height fallback',
    wordSpaceHelp: 'The U+0020 space width stored in the XTF ASCII-width table. A zero table entry falls back to the ASCII default width.',
